/* MPU9250_MS5637_t3_calibrate output magnetometer calibration data
 by: Kris Winer
 date: April 1, 2014
 license: Beerware - Use this code however you'd like. If you 
 find it useful you can buy me a beer some time.

 modified by JRI (john@johniversen.org)
     Outputs continuous magenetometer data that can be read by plotMagCal.m to plot in realtime and calculate accurate correction factors.
     To compute calibration, start matlab plotMagCal.m, then run this sketch, waving the device around to fill the sphere on screen.
     Then, take the calibration values from matlab and put into the main joystick headtracker sketch MPU9250_MS5637_t3_Joy
...
float mRes;                  // scale resolutions per LSB for the sensor
...
void setup()
{
  ...
  Serial.println("JRI: Magnetometer calibration");
 ...
 */
  ...
  //spew magnetometer data to serial, forever
  Serial.println("Mag Calibration: Wave device around to cover full range of orientations!");
  delay(4000);
